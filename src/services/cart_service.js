...
class CartService {
    ...
    async updateCart(userId, cartId, productId, color, shouldAddProduct = true) {
        try {
            ...
            const response = await this.respository.updateCart(cartId, productId, color, shouldAddProduct);
            return response;
        } catch(error) {
