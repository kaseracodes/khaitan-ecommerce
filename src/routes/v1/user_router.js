...
const { createUser, signin, updateUserDetails, verifyUserRole, verifyUserOTP, getRoleUnverifiedUsers, getAdminUsers, getRegularUsers, changeUserRole }  = UserController;
